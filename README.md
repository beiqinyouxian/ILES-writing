...
面向 6.5 分的离线 IELTS Writing 学习与练习工具。v1 完整涵盖 Lesson 1（考试概览 + 动态图），包含：
- 课程概览（要点提炼，不是 PDF 墙）
- 动态图改写填空练习（线/饼示例）
...
## 四、内容与范围（v1）
- Lesson 1：完整（考试概览、动态图写法、常用词、五大趋势句型、改写填空练习）
- Lesson 2-5：导航可用，内容为预告（可按需补充 `content/` JSON）

## 五、二次扩展（可选建议）
- 在 `content/lesson1.json` 中追加更多改写/翻译练习块
